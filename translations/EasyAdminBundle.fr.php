...
return [
    ...
    'filter' => [
        ...
        'label.contains_any_of' => 'contient un des',
        'label.does_not_contain_all_of' => 'ne contient pas tous',
        'label.does_not_match_exactly' => 'ne correspond pas exactement',
        'label.does_not_contain_any_of' => 'ne contient aucun',
        'label.contains_all' => 'contient tous',
        'label.matches_exactly' => 'correspond exactement',
